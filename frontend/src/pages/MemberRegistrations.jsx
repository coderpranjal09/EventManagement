...
import { memberAPI, eventsAPI } from '../utils/api';
...
const MemberRegistrations = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const res = await memberAPI.searchRegistrations({
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Search and view registrations for your committee's events.</p>
      </div>
