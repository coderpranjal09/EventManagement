...
const MemberReports = () => {
  ...
  const fetchReports = async () => {
    try {
      const response = await memberAPI.getReports();
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            View reports for your committee's events and attendance.
          </p>
        </div>
        ...
        <div className="mb-6">
          <button
            onClick={() => exportToCSV(reportsData.eventReports, 'member_reports.csv')}
